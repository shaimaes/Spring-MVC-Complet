...
import fr.formation.inti.service.MyDBAuthenticationService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// For ADMIN only.
		http.authorizeRequests().antMatchers("/admin", "/listemp", "/addemp","/editemp","/save","/delete").access("hasRole('ROLE_ADMIN')");
